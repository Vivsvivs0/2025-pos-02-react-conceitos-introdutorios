...
const Tarefa: React.FC<TarefaProps> = ({ titulo, concluido }) => {
	...
	const classe = `p-3 mb-3 rounded-lg shadow-md hover:cursor-pointer hover:border ${
		estaConcluido
			...
			: "bg-pink-300 hover:border-pink-400"
	}`;
...
const Home = () => {
	const tarefas = [
		{ id: 1, title: "Estudar pro Enem", completed: false },
		{ id: 2, title: "Enem enem enem enem", completed: true },
		{ id: 3, title: "Terapia", completed: false },
	];
